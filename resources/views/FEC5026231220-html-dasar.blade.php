...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ asset('css/FEC5026231220-html-dasar/testingsatu.css') }}" />
    <title>
  ...
  <body>
    ...
    <h6 style="color: white">
      Oleh : itsash <span><i>|</i></span> 18 <span><i>|</i></span> Source : ITS
      Online
    </h6>
    <p>
      <img
        src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_084851-768x432.jpg"
        alt="Pelatihan Spiritual dan Kebangsaan 2023"
        style="width: 400"
      />
    </p>
    <p class="desc">
    ...
    <p>
      <img src="{{ asset('img/FEC5026231220-html-dasar/Pak Adi.jpg') }}" alt="Foto Pak Adi" />
    </p>
    <p class="desc">
